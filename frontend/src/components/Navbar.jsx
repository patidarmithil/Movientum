      ...
      <div className="navbar__inner">
        ...
        <div className="navbar__right-group">
          ...
          {(location.pathname === '/intro' || location.pathname === '/about' || (location.pathname === '/' && !isLoggedIn)) ? (
            <>
              <a href="https://drive.google.com/file/d/1Z4cJntacHK7yXh1dub5aEJNe38mWkZD5/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn btn--ghost btn--sm" style={{ marginRight: '8px' }}>
              ...
              <div className="navbar__user" ref={dropRef}>
                ...
                {dropOpen && (
                  <div className="navbar__dropdown" role="menu" id="navbar-dropdown">
                    ...
                    <a
                      href="https://drive.google.com/file/d/1Z4cJntacHK7yXh1dub5aEJNe38mWkZD5/view?usp=sharing"
                      target="_blank"
